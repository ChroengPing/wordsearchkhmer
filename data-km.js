...
/* -----------------------------------------------------------------------
 * Khmer language data — word banks + UI strings + text segmenter
...
const CATEGORIES = [
  ...
  { id: "colors", icon: "🎨", name: "ពណ៌", en: "Colors", words: [
    ...
    {kh:"លឿងទុំ",en:"orange"},{kh:"ស្វាយ",en:"purple"}, // VERIFY ស្វាយ=purple
  ]},
  ...
  { id: "fruits", icon: "🍎", name: "ផ្លែឈើ", en: "Fruits", words: [
    ...
    {kh:"ក្រូច",en:"orange"},{kh:"ទទឹម",en:"pomegranate"},{kh:"ផ្លែប៉ោម",en:"apple"}, // VERIFY
    {kh:"ទំពាំងបាយជូរ",en:"grape"},{kh:"ស្ដៅ",en:"guava"},{kh:"មៀន",en:"longan"},
  ]},
  { id: "vegetables", icon: "🥬", name: "បន្លែ", en: "Vegetables", words: [
    {kh:"ត្រកួន",en:"morning glory"},{kh:"ស្ពៃ",en:"cabbage"},{kh:"ការ៉ុត",en:"carrot"}, // VERIFY
    {kh:"ត្រសក់",en:"cucumber"},{kh:"ខ្ទឹមស",en:"garlic"},{kh:"ខ្ទឹមក្រហម",en:"shallot"},
    {kh:"ដំឡូង",en:"potato"},{kh:"ប៉េងប៉ោះ",en:"tomato"},{kh:"ត្រប់",en:"eggplant"}, // VERIFY
